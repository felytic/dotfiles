...
-- local cpu_widget = require("multi-cpu-widget")
...
beautiful.init("/home/gulko/.config/awesome/theme.lua")
...
local volumewidget = wibox.container.margin(volume.bar, 7, 7, 3, 3)
...
clientkeys = gears.table.join(
    ...
    awful.key({ }, "F10", function () awful.util.spawn_with_shell("slock") end),
    awful.key({ }, "Print", function () awful.util.spawn_with_shell("import screenshot.png") end),
