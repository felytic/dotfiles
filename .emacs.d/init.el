...
(set-face-attribute 'default nil :font "xos4 Terminus-16")
...
(use-package neotree
  ...
  (evil-define-key 'normal neotree-mode-map (kbd "<C-return>") 'neotree-change-root)
  ...
  (setq neo-hidden-regexp-list '("venv" "\\.pyc$" "~$" "^#.*#$" "\\.elc$"
